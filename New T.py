...
connect=mysql.connector.connect(host="localhost",port="3306",user="root",password="SHAS@2000",database=" bank")
...
while ch != 8:
    ...
    if ch == '1':
        ...
        print("\t__________________THANKS FOR USING SHAS BANK MANAGEMENT MINI PROJECT_______________________")
        break
    else :
        print("Invalid choice")
